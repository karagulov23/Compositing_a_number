...
import orlo.karagulov.compositing_a_number.data.GameRepositoryImpl
...
import orlo.karagulov.compositing_a_number.domain.usecases.GenerateQuestionUseCase
import orlo.karagulov.compositing_a_number.domain.usecases.GetGameSettingUseCase
...
class GameViewModel(
    ...
    fun checkAnswerForSound(number: Int): Boolean {
        val rightAnswer = question.value?.rightAnswer
